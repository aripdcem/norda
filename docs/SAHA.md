...
| 3 | 2026-08-29 | v0.9.8 | **Temiz** — 57:17, güç tasarrufu kapalı, Strava ile paralel. Çapraz doğrulama **SIFIR fark**: 5613,7 ↔ 5613,7 m (elle mola yok; 4 mikro boşluk ≤7 sn); ▲202/▼189 birebir; 1738 nokta = kabul sayacı; doğruluk/ışınlama/zaman reti 0. 🔋 %9 (~9,4 %/sa — Strava paralel + karşılaştırma ekranı; Norda'ya tek başına mal edilemez). Edinim ~40 sn — Strava'dan yavaş hissedildi (bilinen aGPS'siz karakter; uydu satırı izliyor) |
