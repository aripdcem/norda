...
| 3 | 2026-08-29 | v0.9.8 | **Temiz** — 57:17, güç tasarrufu kapalı. Çapraz doğrulama **SIFIR fark**: 5613,7 ↔ 5613,7 m (elle mola yok; 4 mikro boşluk ≤7 sn); ▲202/▼189 birebir; 1738 nokta = kabul sayacı; doğruluk/ışınlama/zaman reti 0. 🔋 %9 (~9,4 %/sa, **Norda tek başına** — düzeltme: Strava paralel koşmadı, önceki deneyim aktarımıymış; ekran durumu soruldu — kayıt ekranı `keepScreenOn` ile açık kaldıysa ekran maliyeti dahildir). Edinim ~40 sn; "Strava hemen başlıyor" farkı tasarımdan: Strava ağ konumuyla anında kayıt gösterir, Norda yalnız kaliteli gerçek GPS noktası yazar |
